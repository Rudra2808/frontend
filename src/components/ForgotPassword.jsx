...
import { Mail, Home, ArrowRight, ArrowLeft, Lock, User } from 'lucide-react'
...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!username || !email || !newPassword) return alert("All fields are required")
    setIsLoading(true)
            ...
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="flex justify-start">
                <button
                  ...
                  className="flex items-center gap-2 text-teal-600 hover:text-teal-500 font-medium transition-colors"
                >
                 ...
                 <form onSubmit={handleSubmit} className="space-y-6">
                   ...
                   <button
                     ...
                     disabled={isLoading || !username || !email || !newPassword}
                   >
                     {isLoading ? (
                 ...
                 <div className="space-y-6">
                   ...
                   <div className="space-y-4">
                     <button
                       onClick={handleBackToLogin}
                       className="w-full h-12 bg-teal-600 hover:bg-teal-700 text-white font-medium transition-colors rounded-lg"
                     >
                       Back to login
                     </button>
                     ...
                     <button
                       ...
                       className="w-full h-12 border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium transition-colors rounded-lg"
                     >
